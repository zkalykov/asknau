    ...
    <div className="demo-page">
      <div className="demo-container">
        ...
        <div className="demo-description">
          ...
          <p>
            It is powered by the GPT latest model, a cutting-edge language processing AI developed by OpenAI and machine learning models according to local databases. This model allows AskNAU to understand and respond to a wide range of queries with human-like accuracy.
          </p>
        </div>
        ...
        <div className="demo-section">
          ...
          <p>
            ...
            <a href="mailto:zhyrgalbekkalykov@gmail.com">zhyrgalbekkalykov@gmail.com</a> (Zhyrgalbek Kalykov) or{' '}
            <a href="mailto:sadhikari@na.edu">sadhikari@na.edu</a> (Professor Sabina Adhikari).
          </p>
        </div>

        {/* For Developers */}
        <div className="demo-section">
          <h2 className="section-title">⚒️ For developers</h2>
          <p>
          ...
          <ol>
            <li>
              ...
              <code>git clone https://github.com/zkalykov/asknau.git</code> in your terminal.
            </li>
            <li>
              Navigate into the project directory with <code>cd asknau</code>.
            </li>
            <li>
              Install the necessary dependencies by running <code>npm install</code>.
            </li>
            <li>
              Start the application locally with <code>npm start</code>. This will launch the app in your browser at{' '}
              <code>http://localhost:3000</code>.
            </li>
          </ol>
          <p>
            You can find further documentation and ways to get involved by visiting our{' '}
            <a href="https://github.com/zkalykov/asknau" className="text-blue-500 hover:text-blue-700 transition duration-300 ease-in-out">
              GitHub page
            </a>
            .
          </p>
